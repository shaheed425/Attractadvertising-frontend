      ...
      {date && (
        <div className="bg-gradient-to-r from-[#5B49AD]/20 via-black/80 to-[#5B49AD]/10 border border-[#5B49AD]/40 p-6 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-4 shadow-2xl">
          ...
          <button
            type="button"
            onClick={onNext}
            className="w-full md:w-auto tech-button !bg-[#5B49AD] !text-white px-5 sm:px-8 py-3.5 sm:py-4 uppercase text-xs tracking-[0.15em] sm:tracking-[0.2em] font-bold shadow-[0_0_20px_rgba(91,73,173,0.4)]"
          >
